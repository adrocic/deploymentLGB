...
var summonerInstance_1 = require("./summonerInstance");
var matchInstance_1 = require("./matchInstance");
var leagueInstance_1 = require("./leagueInstance");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                matchList = _a.sent();
                if (matchList) {
                    clone = __spreadArrays(matchList.data.matches).slice(0, 40);
                    res.json(clone);
                }
                else {
                    res.status(404);
